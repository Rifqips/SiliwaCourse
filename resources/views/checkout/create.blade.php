                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{route('checkout.store', $camp->id)}}" class="basic-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="ocupation" type="text" class="form-control {{$errors->has('ocupation') ? 'is-invalid' : ''}}" value="{{old('ocupation') ?: Auth::user()->ocupation}}" required  />
                                @if ($errors->has('ocupation'))
                                    <p class="text-danger">{{$errors->first('ocupation')}}</p>
                                @endif
                            </div>
                            <div class="mb-4">
